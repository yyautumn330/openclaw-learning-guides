    ...
    namespace CryptoJS {
        ...
        export namespace lib {
            ...
            const CipherParams: {
                 ...
                 *     });
                 */
                create(cipherParams: Partial<CipherParams> | object): CipherParams;
            };
        ...
        export namespace x64 {
             ...
             */
            const WordArray: {
                create(words?: X64WordArray[] |X64Word[], sigBytes?: number): X64WordArray;
            };
        }
        ...
        interface Encoder {
             ...
             */
            stringify(wordArray: WordArray | object): string;
            /**
        ...
        interface Cipher {
             ...
             *
             */
            encryptBlock(words:Array<any>, offset:number):void
        }
        ...
        export interface CipherStatic {
             ...
             */
            createEncryptor(key: WordArray | object, cfg?: CipherOption | object): Cipher;
